				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Rs.'.$row['product_price'].'<del 
							...
							<ul class="product-links">
								...
								<li><a href="#">Medical Equiments</a></li>
							</ul>
												...
												<ul class="reviews">
													<li>
														...
														<div class="review-body">
															<p>I always prefer this website</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Dikpal</h5>
															<p class="date"> 28 May 2020, 9:0 PM PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Good medicine, Professional home delievery and Good price</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Aabi </h5>
															<p class="date">27 May 2020, 10:0 PM, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>Rs.$pro_price<del</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
