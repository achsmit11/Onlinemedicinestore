...
mysqli_query($con,"insert into precription (name,mobile, p_address, product_image) values ('$product_name','$price','$details','$pic_name')") or die ("query incorrect");
         ...
         <div class="col-md-7">
            <div class="card">
              <div class="card-header card-header-primary">
                <h5 class="title">Add Precription</h5>
              </div>
              <div class="card-body">
